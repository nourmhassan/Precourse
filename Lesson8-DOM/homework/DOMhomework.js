...
let created = document.querySelector('#createdBy').innerHTML = 'This app was created by: Nour Hassan';

function Todo(descciptionofobject) {
...
function buildTodo(param1, param2) {
  ...
  */
  ...
  todoText.innerHTML = param1.description;
  todoText.id = param2;
...
function buildTodos(param) {
  ...
  */
  var newMappedArray = param.map(buildTodo);
...
function displayTodos() {
  ...
  */
  var containerOfTodo = document.getElementById('todoContainer');
  containerOfTodo.innerHTML = "";
  var res = buildTodos(toDoItems);

  for (var i = 0; i < res.length; i++) {

    containerOfTodo.appendChild(res[i])
  }
  return containerOfTodo;
}
...
*/
  ...
  var newTodo2 = new Todo(newTodo);
  toDoItems.push(newTodo2);
